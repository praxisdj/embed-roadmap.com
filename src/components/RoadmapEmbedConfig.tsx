...
interface RoadmapEmbedConfigProps {
  ...
  onSave: (config: { embedStyles: EmbedStyles }) => Promise<void>;
...
export default function RoadmapEmbedConfig({
  ...
  const updateStatusColor = (
    status: keyof EmbedStyles["statusColors"],
    color: string,
  ) => {
    setStyles((prev) => ({
      ...prev,
                ...
                <div key={status} className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <Input
                      ...
                      onChange={(e) =>
                        updateStatusColor(
                          status as keyof EmbedStyles["statusColors"],
                          e.target.value,
                        )
                      }
                      className="w-12 h-8"
  ...
  frameborder="0">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            See how your embedded roadmap will look with the current styling in
            Kanban board format
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-4 min-h-[400px]">
                {Object.entries(getStatusColors()).map(([status, color]) => {
                  ...
                  const features =
                    mockFeatures[status as keyof typeof mockFeatures] || [];
          ...
          <div className="mt-3 text-xs text-muted-foreground">
            💡 This Kanban board preview updates in real-time as you change
            colors
          </div>
        </CardContent>
      </Card>
